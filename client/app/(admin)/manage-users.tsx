...
const ManageUsers = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: undefined }}>
      <View className="flex-1 bg-background">
        ...
        {/* Make this content area fill remaining space so FlatList can scroll */}
        <View className="px-6 py-4 flex-1">
          ...
          {/* LIST WRAPPER - give this area flex so FlatList can take height and scroll */}
          <View style={{ flex: 1 }}>
            {loading ? (
              // Lottie Loader (centered)
              <View
              ...
              <FlatList
                ...
                // Give FlatList flex so it can expand to available space and scroll
                style={{ flex: 1 }}
                contentContainerStyle={{ paddingBottom: 16 }}
                keyboardShouldPersistTaps="handled"
                ListFooterComponent={() => (
                  <View className="mt-2 mb-16 px-2">
          ...
          {/* Pagination (keeps it below the scrollable list) */}
        </View>
      </View>
    </SafeAreaView>
  );
